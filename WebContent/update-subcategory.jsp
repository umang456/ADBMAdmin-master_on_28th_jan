						...
						novalidate="" data-parsley-validate="" >
							...
							<div class="form-group">
								...
								<input
									...
									name="subcat_name"
									data-parsley-id="4"
									value="<%= session.getAttribute("subcat_name") %>">
							</div>
							<div class="form-group">
								...
								<textarea type="text" 
									...
									><%= session.getAttribute("subcat_desc") %></textarea>

							</div>

							<div class="form-group text-right m-b-0">
								<input type="hidden" name="flag" value="updated_subcat">
								<input type="hidden" name="subcat_id" value="<%= session.getAttribute("subcat_id") %>">
