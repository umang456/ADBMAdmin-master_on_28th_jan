		...
		<div class="content-page">
			...
			<div class="content">
				<div class="container">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 class="page-title">Search Category</h4>
							<ol class="breadcrumb">
								<li><a href="#">Ubold</a></li>
								<li><a href="#">Tables</a></li>
								<li class="active">searchcategorytable</li>
							</ol>
						</div>
					</div>
						...
						<div class="col-sm-12">
							<div class="card-box table-responsive">
								...
								<table id="datatable" class="table table-striped table-bordered">
									...
									<%-- href"<%= request.getContextPath() %>/CategoryController?flag=editCategory&catId=${categoryid }" --%>
									<tbody>
										<c:forEach items="${sessionScope.cat_list }" var="cat_list">
											<tr>
												<td>${cat_list.cat_id }</td>
												<td>${cat_list.cat_name }</td>
												<td>${cat_list.cat_desc }</td>
												<td>
												<a href="<%=request.getContextPath()%>/CategoryController?id=${cat_list.cat_id }&flag=update">Update</a> /
												<a href="<%=request.getContextPath()%>/CategoryController?id=${cat_list.cat_id }&flag=delete">Delete</a>
												</td>
											</tr>
										</c:forEach>
