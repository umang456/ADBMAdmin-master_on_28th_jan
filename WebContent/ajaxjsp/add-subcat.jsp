				...
				<div class="container">
					...
					<div class="card-box">
						...
						<form novalidate="" data-parsley-validate=""
							action="SubCategoryController" method="post">

							<div class="form-group">
								` <label for="exampleInputEmail1">Select Category</label> <select
									class="form-control" name="cat_id">
									<c:forEach items="${sessionScope.category_list }" var="cate_list">
										<option label="${cate_list.cat_name }"value="${cate_list.cat_id }">
											${cate_list.cat_name }
										</option>
									</c:forEach>
									<!-- 
							...
							<div class="form-group">
								<label for="categoryName">Sub Category Name</label> <input
									...
									parsley-trigger="change" name="subcat_name" data-parsley-id="4">
							</div>
							<div class="form-group">
								...
								<textarea type="text" id="subcategory_description"
									...
									parsley-trigger="change" name="subcat_desc" data-parsley-id="6"></textarea>
